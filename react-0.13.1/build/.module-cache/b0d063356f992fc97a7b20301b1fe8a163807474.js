...
var Editor2 = React.createClass({displayName: "Editor2",
  ...
  render: function() {
    ...
    for (var iLine = this.state.firstLinePos; iLine < this.state.firstLinePos + this.props.linesVisible; iLine += 1) {
      content.append(this.props.text.substr(Position(iLine, this.state.firstColumnPos),
                  Position(iLine, this.state.firstColumnPos + this.props.columnsVisible)));
    }
